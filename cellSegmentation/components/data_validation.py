...
# Note: DataIngestionArtifact will return the data_zip_file path and feature_store path and we can check these in validation
...
class DataValidation:
    ...
    def validate_all_files_exist(self)-> bool:
        try:
            validation_status = None # boolean to return of all required files exist 

            all_files = os.listdir(self.data_ingestion_artifact.feature_store_path)
                            # returns list of directories in the give folder path
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            # copy data.zip file to root folder
            # everything we want to perform is  from root folder
            if status:
