...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            logging.info(
                "Entered the start_data_ingestion method in TrainPipeline class"
            )
            logging.info(
            ...
            logging.info(
                "Exited the start_data_ingestion method in TrainPipeline class"
            )
    ...
    def start_data_validation(
            self, data_ingestion_artifact: DataValidationArtifact
    ...
    '''
    Method to execute the start_data_ingestion method
    '''
    def run_pipeline(self) -> None:
        try:
            ...
            if data_validation_artifact.validation_status == True:
                ...
                raise Exception("your input data is not in the correct format. Validation_status is False")
